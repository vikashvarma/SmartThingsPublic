...
definition(
    ...
    namespace: "vvarma",
    author: "Vikash Varma",
    description: "Maintain humidity in a room by connecting humidity sensor and switch with humidifier and dehumidifier",
    category: "My Apps",
...
preferences {
	page (name: "mainPage", title: "Set Preference", nextPage: "pageTwo", uninstall: true) {
        section("Settings") {
